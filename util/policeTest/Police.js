...
//       .median(5) // Apply a stronger median filter for noise reduction
//       .normalize() // Normalize brightness and contrast
//       .modulate({ contrast: 3, brightness: 1.2 }) // Boost contrast and adjust brightness
//       .threshold(128) // Apply binary thresholding with a mid-range value
//       .sharpen({ sigma: 1.5, m1: 1, m2: 0 }) // Sharpen edges with stronger parameters
//       .toBuffer();
